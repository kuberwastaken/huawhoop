...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    static final class SafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> abstractFuture, Waiter waiter, Waiter waiter2) {
            return CustomWebView$$ExternalSyntheticBackport0.m(this.waitersUpdater, abstractFuture, waiter, waiter2);
        }

        @Override // androidx.work.impl.utils.futures.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, Listener listener, Listener listener2) {
            return CustomWebView$$ExternalSyntheticBackport0.m(this.listenersUpdater, abstractFuture, listener, listener2);
        }

        @Override // androidx.work.impl.utils.futures.AbstractFuture.AtomicHelper
        boolean casValue(AbstractFuture<?> abstractFuture, Object obj, Object obj2) {
            return CustomWebView$$ExternalSyntheticBackport0.m(this.valueUpdater, abstractFuture, obj, obj2);
        }
    }
