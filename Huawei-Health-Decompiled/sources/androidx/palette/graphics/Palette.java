...
public final class Palette {
    ...
    public static final class Builder {
        ...
        */
        private android.graphics.Bitmap scaleBitmapDown(android.graphics.Bitmap r6) {
            /*
                r5 = this;
                int r0 = r5.mResizeArea
                if (r0 <= 0) goto L19
                int r0 = r6.getWidth()
                int r1 = r6.getHeight()
                int r0 = r0 * r1
                int r1 = r5.mResizeArea
                if (r0 <= r1) goto L32
                double r1 = (double) r1
                double r3 = (double) r0
                double r1 = r1 / r3
                ...
                goto L34
            L19:
                int r0 = r5.mResizeMaxDimension
                if (r0 <= 0) goto L32
                int r0 = r6.getWidth()
                int r1 = r6.getHeight()
                int r0 = java.lang.Math.max(r0, r1)
                int r1 = r5.mResizeMaxDimension
                if (r0 <= r1) goto L32
                double r1 = (double) r1
                double r3 = (double) r0
                double r0 = r1 / r3
