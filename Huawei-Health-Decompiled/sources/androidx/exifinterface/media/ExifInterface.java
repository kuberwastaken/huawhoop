...
public class ExifInterface {
    ...
    static {
        ...
        simpleDateFormat2.setTimeZone(TimeZone.getTimeZone(DataResult.UTC));
        int i = 0;
        while (true) {
    ...
    static class ExifAttribute {
        ...
        /* JADX WARN: Not initialized variable reg: 3, insn: 0x0182: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:137:0x0182 */
        /* JADX WARN: Removed duplicated region for block: B:181:0x019c A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean isSupportedMimeType(java.lang.String r3) {
        /*
    ...
    public void setAttribute(String str, String str2) {
        ...
        if ((TAG_DATETIME.equals(str3) || TAG_DATETIME_ORIGINAL.equals(str3) || TAG_DATETIME_DIGITIZED.equals(str3)) && strReplaceAll != null) {
            ...
            if (zFind2) {
                strReplaceAll = strReplaceAll.replaceAll(com.huawei.openalliance.ad.constant.Constants.LINK, ":");
            }
        }
                    ...
                    switch (i) {
                        ...
                        case 10:
                            ...
                            while (i10 < strArrSplit6.length) {
                                ...
                                rationalArr2[i10] = new Rational((long) Double.parseDouble(strArrSplit7[0]), (long) Double.parseDouble(strArrSplit7[i3]));
                                i10++;
    ...
    /* JADX WARN: Not initialized variable reg: 9, insn: 0x013b: MOVE (r1 I:??[OBJECT, ARRAY]) = (r9 I:??[OBJECT, ARRAY]), block:B:83:0x013b */
    /* JADX WARN: Removed duplicated region for block: B:64:0x00e6 A[Catch: all -> 0x010e, Exception -> 0x0111, TryCatch #17 {Exception -> 0x0111, all -> 0x010e, blocks: (B:62:0x00e2, B:64:0x00e6, B:66:0x00fc, B:65:0x00f5), top: B:125:0x00e2 }] */
    /* JADX WARN: Removed duplicated region for block: B:65:0x00f5 A[Catch: all -> 0x010e, Exception -> 0x0111, TryCatch #17 {Exception -> 0x0111, all -> 0x010e, blocks: (B:62:0x00e2, B:64:0x00e6, B:66:0x00fc, B:65:0x00f5), top: B:125:0x00e2 }] */
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x00b3: MOVE (r1 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:60:0x00b2 */
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r9.mAssetInputStream     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            if (r1 == 0) goto L2f
            boolean r3 = r1.markSupported()     // Catch: java.lang.Throwable -> L24 java.lang.Exception -> L2a
            if (r3 == 0) goto L1b
            r1.reset()     // Catch: java.lang.Throwable -> L24 java.lang.Exception -> L2a
            goto L3a
        L1b:
            java.lang.String r3 = "Cannot read thumbnail from inputstream without mark/reset support"
            android.util.Log.d(r0, r3)     // Catch: java.lang.Throwable -> L24 java.lang.Exception -> L2a
        ...
        L2a:
            ...
            goto La3
        L2f:
            java.lang.String r1 = r9.mFilename     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            if (r1 == 0) goto L3c
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            java.lang.String r3 = r9.mFilename     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            r1.<init>(r3)     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
        L3a:
            r3 = r2
            goto L51
        L3c:
            java.io.FileDescriptor r1 = r9.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            java.io.FileDescriptor r1 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r1)     // Catch: java.lang.Throwable -> L9b java.lang.Exception -> L9e
            int r3 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L94 java.lang.Exception -> L96
            r4 = 0
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r4, r3)     // Catch: java.lang.Throwable -> L94 java.lang.Exception -> L96
        ...
        L51:
            if (r1 == 0) goto L8c
            int r4 = r9.mThumbnailOffset     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r5 = r9.mOffsetToExifData     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r4 = r4 + r5
            long r4 = (long) r4     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            long r4 = r1.skip(r4)     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r6 = r9.mThumbnailOffset     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r7 = r9.mOffsetToExifData     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r6 = r6 + r7
            long r6 = (long) r6
            int r4 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            java.lang.String r5 = "Corrupted image"
            if (r4 != 0) goto L86
            int r4 = r9.mThumbnailLength     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            byte[] r4 = new byte[r4]     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r6 = r1.read(r4)     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            int r7 = r9.mThumbnailLength     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            if (r6 != r7) goto L80
            r9.mThumbnailBytes = r4     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto L7f
        ...
        L7f:
            return r4
        L80:
            java.io.IOException r4 = new java.io.IOException     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            r4.<init>(r5)     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            throw r4     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
        L86:
            java.io.IOException r4 = new java.io.IOException     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            r4.<init>(r5)     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            throw r4     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
        L8c:
            java.io.FileNotFoundException r4 = new java.io.FileNotFoundException     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            r4.<init>()     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
            throw r4     // Catch: java.lang.Exception -> L92 java.lang.Throwable -> Lb1
        L92:
            r4 = move-exception
            goto La3
        ...
        La3:
            ...
            android.util.Log.d(r0, r5, r4)     // Catch: java.lang.Throwable -> Lb1
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto Lb0
            androidx.exifinterface.media.ExifInterfaceUtils.closeFileDescriptor(r3)
        Lb0:
        ...
        Lb4:
            ...
            if (r1 == 0) goto Lbc
            androidx.exifinterface.media.ExifInterfaceUtils.closeFileDescriptor(r1)
        Lbc:
            throw r0
        */
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if ((Marker.ANY_NON_NULL_MARKER.equals(strSubstring) || com.huawei.openalliance.ad.constant.Constants.LINK.equals(strSubstring)) && ":".equals(str3.substring(3, 4)) && i2 <= 14) {
                        if (!com.huawei.openalliance.ad.constant.Constants.LINK.equals(strSubstring)) {
                            i = -1;
                        }
                        time += (long) (((i2 * 60) + i3) * 60000 * i);
                    }
                }
                if (str2 != null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x0175 A[LOOP:0: B:10:0x0034->B:64:0x0175, LOOP_END] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B