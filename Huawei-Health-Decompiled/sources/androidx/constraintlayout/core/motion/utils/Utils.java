...
public class Utils {
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + Constants.RIGHT_BRACKET_ONLY + "    ".substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
