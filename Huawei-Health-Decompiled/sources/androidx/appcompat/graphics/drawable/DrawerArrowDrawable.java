...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, R$styleable.DrawerArrowToggle, R.attr._2131100134_res_0x7f0601e6, R.style.Base_Widget_AppCompat_DrawerArrowToggle);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(bounds.centerX(), ((((int) ((fHeight - (3.0f * strokeWidth)) - (2.0f * r7))) / 4) * 2) + (strokeWidth * 1.5f) + this.mBarGap);
        if (this.mSpin) {
            canvas.rotate(fLerp4 * (this.mVerticalMirror ^ z ? -1 : 1));
        } else if (z) {
