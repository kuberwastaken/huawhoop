...
public final class VideoEncoderSettings {
    ...
    public int hashCode() {
        int i = this.bitrate;
        int i2 = this.bitrateMode;
        int i3 = this.profile;
        int i4 = this.level;
        int iFloatToIntBits = Float.floatToIntBits(this.iFrameIntervalSeconds);
        return ((((((((((((((i + 217) * 31) + i2) * 31) + i3) * 31) + i4) * 31) + iFloatToIntBits) * 31) + this.operatingRate) * 31) + this.priority) * 31) + (this.enableHighQualityTargeting ? 1 : 0);
    }
}
