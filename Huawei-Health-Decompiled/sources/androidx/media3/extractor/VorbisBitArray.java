...
public final class VorbisBitArray {
    ...
    public boolean readBit() {
        boolean z = (((this.data[this.byteOffset] & UnsignedBytes.MAX_VALUE) >> this.bitOffset) & 1) == 1;
        skipBits(1);
        return z;
    }
    ...
    public int readBits(int i) {
        ...
        int i3 = i2 + 1;
        int i4 = ((this.data[i2] & UnsignedBytes.MAX_VALUE) >> this.bitOffset) & (255 >> (8 - iMin));
        while (iMin < i) {
            i4 |= (this.data[i3] & UnsignedBytes.MAX_VALUE) << iMin;
            iMin += 8;
            i3++;
        }
        skipBits(i);
