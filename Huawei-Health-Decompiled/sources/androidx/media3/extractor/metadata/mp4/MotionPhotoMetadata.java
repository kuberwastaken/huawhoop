...
public final class MotionPhotoMetadata implements Metadata.Entry {
    ...
    public int hashCode() {
        int iHashCode = Longs.hashCode(this.photoStartPosition);
        int iHashCode2 = Longs.hashCode(this.photoSize);
        return ((((((((iHashCode + 527) * 31) + iHashCode2) * 31) + Longs.hashCode(this.photoPresentationTimestampUs)) * 31) + Longs.hashCode(this.videoStartPosition)) * 31) + Longs.hashCode(this.videoSize);
    }
