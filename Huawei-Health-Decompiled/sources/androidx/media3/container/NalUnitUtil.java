...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            int i3 = i + 1;
            if (i3 < iPosition) {
                int i4 = byteBuffer.get(i) & UnsignedBytes.MAX_VALUE;
                if (i2 == 3) {
    ...
    */
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            iIsoTransferCharacteristicsToColorTransfer = i6;
            f = f2;
        } else {
            f = 1.0f;
            i3 = i15;
        ...
        return new H265SpsData(bits2, bit, bits3, i8, unsignedExpGolombCodedInt2, unsignedExpGolombCodedInt9, unsignedExpGolombCodedInt10, iArr, bits4, unsignedExpGolombCodedInt, i14, i3, f, iMax, iIsoTransferCharacteristicsToColorTransfer, i4, i5);
    }
    ...
    private static void skipHrdParameters(ParsableNalUnitBitArray parsableNalUnitBitArray) {
        int unsignedExpGolombCodedInt = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
        parsableNalUnitBitArray.skipBits(8);
        for (int i = 0; i < unsignedExpGolombCodedInt + 1; i++) {
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.skipBit();
        }
