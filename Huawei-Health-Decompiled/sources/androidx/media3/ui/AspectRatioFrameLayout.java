...
public final class AspectRatioFrameLayout extends FrameLayout {
    ...
    public AspectRatioFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, new int[]{R.attr._2131101399_res_0x7f0606d7}, 0, 0);
            try {
                this.resizeMode = typedArrayObtainStyledAttributes.getInt(0, 0);
            } finally {
