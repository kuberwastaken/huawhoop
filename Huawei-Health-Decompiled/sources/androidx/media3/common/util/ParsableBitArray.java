...
public final class ParsableBitArray {
    ...
    public int readBits(int i) {
        ...
        assertValidOffset();
        return ((-1) >>> (32 - i)) & (((b & UnsignedBytes.MAX_VALUE) >> (8 - i2)) | i3);
    }
    ...
    public void readBits(byte[] bArr, int i, int i2) {
        ...
        if (i8 + i7 > 8) {
            ...
            bArr[i3] = (byte) (b3 | ((bArr3[i9] & UnsignedBytes.MAX_VALUE) << i8));
            this.bitOffset = i8 - 8;
        }
    ...
    public void putInt(int i, int i2) {
        ...
        byte[] bArr = this.data;
        int i5 = this.byteOffset;
        byte b = (byte) (((MotionEventCompat.ACTION_POINTER_INDEX_MASK >> i3) | ((1 << i4) - 1)) & bArr[i5]);
        bArr[i5] = b;
        int i6 = i2 - iMin;
