...
public final class ColorInfo {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            int iHashCode = Arrays.hashCode(this.hdrStaticInfo);
            this.hashCode = ((((((((((i + 527) * 31) + i2) * 31) + i3) * 31) + iHashCode) * 31) + this.lumaBitdepth) * 31) + this.chromaBitdepth;
        }
