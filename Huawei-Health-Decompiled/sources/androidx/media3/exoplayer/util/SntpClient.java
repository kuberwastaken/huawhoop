...
public final class SntpClient {
    ...
    public static long loadNtpTimeOffsetMs() throws IOException {
        ...
        try {
            ...
            checkValidServerReply((byte) ((b >> 6) & 3), (byte) (b & 7), b2 & UnsignedBytes.MAX_VALUE, timestamp3);
            long j2 = ((timestamp2 - timestamp) + (timestamp3 - j)) / 2;
    ...
    private static void writeTimestamp(byte[] bArr, int i, long j) {
        ...
        long j2 = j / 1000;
        long j3 = OFFSET_1900_TO_1970 + j2;
        bArr[i] = (byte) (j3 >> 24);
        bArr[i + 1] = (byte) (j3 >> 16);
        bArr[i + 2] = (byte) (j3 >> 8);
        bArr[i + 3] = (byte) j3;
