...
public final class DownloadRequest implements Parcelable {
    ...
    public final int hashCode() {
        ...
        int iHashCode4 = this.streamKeys.hashCode();
        int iHashCode5 = Arrays.hashCode(this.keySetId);
        String str2 = this.customCacheKey;
        return (((((((((((iHashCode * 961) + iHashCode2) * 31) + iHashCode3) * 31) + iHashCode4) * 31) + iHashCode5) * 31) + (str2 != null ? str2.hashCode() : 0)) * 31) + Arrays.hashCode(this.data);
    }
