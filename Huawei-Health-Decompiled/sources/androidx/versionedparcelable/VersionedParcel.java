...
public abstract class VersionedParcel {
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + string + Constants.RIGHT_BRACKET_ONLY, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + string + Constants.RIGHT_BRACKET_ONLY, e2);
        }
    }
