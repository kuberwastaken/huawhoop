...
final class CamUtils {
    ...
    static float[] xyzFromInt(int i) {
        ...
        float f6 = fArr3[2];
        float[] fArr4 = fArr[2];
        return new float[]{(f * fLinearized) + (f2 * fLinearized2) + (f3 * fLinearized3), (f4 * fLinearized) + (f5 * fLinearized2) + (f6 * fLinearized3), (fLinearized * fArr4[0]) + (fLinearized2 * fArr4[1]) + (fLinearized3 * fArr4[2])};
    }
