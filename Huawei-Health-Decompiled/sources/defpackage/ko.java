...
public class ko {
    ...
    public static String f14778a = "idnjfhncnsfuobcnt847y929o449u474w7j3h22aoddc98euk#%&&)*&^%#";
    ...
    public static PBEKeySpec b(String str) throws IllegalAccessException, NoSuchMethodException, InstantiationException, ClassNotFoundException, InvocationTargetException {
        Class<?> cls = Class.forName(new String(kp.a("amF2YS5zZWN1cml0eS5TZWN1cmVSYW5kb20=")));
    ...
    public static byte[] d(PBEKeySpec pBEKeySpec, byte[] bArr, byte[] bArr2) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException, ShortBufferException {
    ...
    public static void b(StringBuffer stringBuffer, byte b) {
    ...
    public static String b(String str, String str2) {
        try {
            return a(d(b(str), str2.getBytes(), a()));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static String e() {
        ...
        for (int i = 0; i < f14778a.length() - 1; i += 4) {
            str = str + f14778a.charAt(i);
        }
        return str;
    }
}
