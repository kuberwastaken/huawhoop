...
public class kg {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            if (kg.this.d == null) {
                kg kgVar = kg.this;
                kgVar.d = kgVar.new c(kgVar.c);
                kg.this.d.setCancelable(kg.this.g);
            }
            try {
                if (kg.this.d.isShowing()) {
                    return;
                }
                kg.this.d.show();
                kg.this.f.sendEmptyMessageDelayed(1, 10000L);
            } catch (Exception e) {
                ov.b(e);
            }
        }
    ...
    public class e implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (kg.this.d == null || !kg.this.d.isShowing()) {
                return;
            }
            try {
                kg.this.f.removeMessages(1);
                kg.this.d.dismiss();
            } catch (Exception e) {
                ov.b(e);
            }
    ...
    public class c extends AlertDialog {
        ...
        public final View be_(Context context) {
            ...
            layoutParams2.setMargins(a(kg.this.c, 17.0f), a(kg.this.c, 10.0f), a(kg.this.c, 8.0f), a(kg.this.c, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(a(context, kg.e, 480));
            ...
            textView.setText(TextUtils.isEmpty(kg.this.f14659a) ? context.getString(R.string._2130852552_res_0x7f023ac8) : kg.this.f14659a);
    ...
    public kg(Activity activity, String str) {
        this.c = activity;
        this.f14659a = str;
    }
}
