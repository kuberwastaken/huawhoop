    ...
    */
    public static byte[] a(java.lang.String r5, java.lang.String r6) throws java.lang.Throwable {
        ...
        L41:
            ...
            r2 = r0
        L43:
            defpackage.ov.b(r5)     // Catch: java.lang.Throwable -> L51
            if (r2 == 0) goto L50
            r2.close()     // Catch: java.io.IOException -> L4c
            goto L50
        L4c:
        ...
        L5d:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.nl.a(java.lang.String, java.lang.String):byte[]");
    }

    public static PublicKey b(String str, String str2) throws Exception {
        return KeyFactory.getInstance(str).generatePublic(new X509EncodedKeySpec(np.b(str2)));
    }
}
