...
public class HwActivityRecognitionEvent implements Parcelable {
    public static final Parcelable.Creator<HwActivityRecognitionEvent> CREATOR = new Parcelable.Creator<HwActivityRecognitionEvent>() { // from class: com.hihonor.systemserver.activityrecognition.HwActivityRecognitionEvent.2
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        Log.e("ARMoudle.HwActivityRecognition", "ARServiceVersion : " + HwActivityRecognition.e());
        if (HwActivityRecognition.e() == 1) {
