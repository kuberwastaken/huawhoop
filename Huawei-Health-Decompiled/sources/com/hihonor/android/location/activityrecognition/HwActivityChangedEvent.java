...
public class HwActivityChangedEvent implements Parcelable {
    public static final Parcelable.Creator<HwActivityChangedEvent> CREATOR = new Parcelable.Creator<HwActivityChangedEvent>() { // from class: com.hihonor.android.location.activityrecognition.HwActivityChangedEvent.1
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: dM_, reason: merged with bridge method [inline-methods] */
    ...
    public static boolean checkActivityReportLen(int i) {
        ...
        aoq.d(TAG, "report activity invalid.");
        return false;
    }
}
