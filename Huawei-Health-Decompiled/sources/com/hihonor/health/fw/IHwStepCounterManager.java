...
public interface IHwStepCounterManager extends IInterface {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    return true;
                case 7:
                    boolean zInsertDiffStep = insertDiffStep((Bundle) c.dW_(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
        ...
        static class b implements IHwStepCounterManager {
            ...
            public void registerLogCallback(IReportCallback iReportCallback) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IHwStepCounterManager.DESCRIPTOR);
                    parcelObtain.writeStrongInterface(iReportCallback);
                    this.e.transact(9, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public void unRegisterLogCallback(IReportCallback iReportCallback) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IHwStepCounterManager.DESCRIPTOR);
                    parcelObtain.writeStrongInterface(iReportCallback);
                    this.e.transact(10, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
    ...
    public static class c {
        ...
        public static <T> T dW_(Parcel parcel, Parcelable.Creator<T> creator) {
            if (parcel.readInt() != 0) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static <T extends Parcelable> void dX_(Parcel parcel, T t, int i) {
            if (t != null) {
                parcel.writeInt(1);
