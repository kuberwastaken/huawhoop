...
public class GLConvertUtil {
    ...
    public static long getLong(byte[] bArr, int i) {
        return (((long) (bArr[i + 7] & UnsignedBytes.MAX_VALUE)) << 56) + (((long) (bArr[i + 6] & UnsignedBytes.MAX_VALUE)) << 48) + (((long) (bArr[i + 5] & UnsignedBytes.MAX_VALUE)) << 40) + (((long) (bArr[i + 4] & UnsignedBytes.MAX_VALUE)) << 32) + (((long) (bArr[i + 3] & UnsignedBytes.MAX_VALUE)) << 24) + (((long) (bArr[i + 2] & UnsignedBytes.MAX_VALUE)) << 16) + (((long) (bArr[i + 1] & UnsignedBytes.MAX_VALUE)) << 8) + ((long) (bArr[i] & UnsignedBytes.MAX_VALUE));
    }
