...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(65536 - iCardinality, bitSet, strSubstring)) { // from class: com.google.common.base.CharMatcher.1
    ...
    private static final class And extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.and(" + this.first + ", " + this.second + Constants.RIGHT_BRACKET_ONLY;
        }
    }
    ...
    private static final class Or extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.or(" + this.first + ", " + this.second + Constants.RIGHT_BRACKET_ONLY;
        }
    }
    ...
    private static final class Is extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.is('" + CharMatcher.showCharacter(this.match) + Constants.RIGHT_BRACKET;
        }
    }
    ...
    private static final class IsNot extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.isNot('" + CharMatcher.showCharacter(this.match) + Constants.RIGHT_BRACKET;
        }
    }
    ...
    private static final class InRange extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.inRange('" + CharMatcher.showCharacter(this.startInclusive) + "', '" + CharMatcher.showCharacter(this.endInclusive) + Constants.RIGHT_BRACKET;
        }
    }
    ...
    private static final class ForPredicate extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.forPredicate(" + this.predicate + Constants.RIGHT_BRACKET_ONLY;
        }
    }
}
