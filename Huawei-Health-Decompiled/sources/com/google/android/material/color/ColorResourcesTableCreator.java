...
final class ColorResourcesTableCreator {
    ...
    private static final PackageInfo ANDROID_PACKAGE_INFO = new PackageInfo(1, OsType.ANDROID);
    ...
    static class PackageChunk {
        ...
        int getChunkSize() {
            ...
            return chunkSize + 288 + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
