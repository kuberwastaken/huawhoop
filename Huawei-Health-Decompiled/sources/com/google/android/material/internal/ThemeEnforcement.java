...
public final class ThemeEnforcement {
    ...
    private static final int[] APPCOMPAT_CHECK_ATTRS = {R.attr._2131099988_res_0x7f060154};
    private static final int[] MATERIAL_CHECK_ATTRS = {R.attr._2131099993_res_0x7f060159};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{android.R.attr.textAppearance, R.attr._2131100157_res_0x7f0601fd, R.attr._2131100158_res_0x7f0601fe}, i, i2);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(1, false);
        typedArrayObtainStyledAttributes.recycle();
        if (z) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(R.attr._2131100918_res_0x7f0604f6, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        ...
        if (iArr2 == null || iArr2.length == 0) {
            if (typedArrayObtainStyledAttributes.getResourceId(0, -1) != -1) {
