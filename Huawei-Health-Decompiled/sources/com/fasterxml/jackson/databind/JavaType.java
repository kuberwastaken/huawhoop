...
public abstract class JavaType extends ResolvedType implements Serializable, Type {
    ...
    public abstract ahr getBindings();
    ...
    public abstract JavaType refine(Class<?> cls, ahr ahrVar, JavaType javaType, JavaType[] javaTypeArr);
    ...
    public boolean isConcrete() {
        if ((this._class.getModifiers() & HealthData.BLOODPRESURE) == 0) {
            return true;
        }
    ...
    public final boolean isEnumType() {
        return ahv.n(this._class);
    }

    public final boolean isEnumImplType() {
        return ahv.n(this._class) && this._class != Enum.class;
    }

    public final boolean isRecordType() {
        return ahv.q(this._class);
    }
    ...
    public JavaType containedTypeOrUnknown(int i) {
        ...
        return javaTypeContainedType == null ? ahq.e() : javaTypeContainedType;
    }
