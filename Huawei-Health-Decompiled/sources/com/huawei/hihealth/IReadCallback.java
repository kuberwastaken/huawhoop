...
public interface IReadCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IReadCallback {
        ...
        public static IReadCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IReadCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IReadCallback)) {
                return (IReadCallback) iInterfaceQueryLocalInterface;
            }
        ...
        static class Proxy implements IReadCallback {
            ...
            public void onResult(int i, String str, byte[] bArr) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IReadCallback.DESCRIPTOR);
