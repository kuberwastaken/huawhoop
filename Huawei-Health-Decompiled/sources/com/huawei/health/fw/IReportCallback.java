...
public interface IReportCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IReportCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                onResult((Bundle) c.ZB_(parcel, Bundle.CREATOR));
    ...
    public static class c {
        ...
        public static <T> T ZB_(Parcel parcel, Parcelable.Creator<T> creator) {
            if (parcel.readInt() != 0) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static <T extends Parcelable> void ZC_(Parcel parcel, T t, int i) {
            if (t != null) {
                parcel.writeInt(1);
