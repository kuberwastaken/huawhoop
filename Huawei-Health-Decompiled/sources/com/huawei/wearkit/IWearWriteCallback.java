...
public interface IWearWriteCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWearWriteCallback {
        ...
        public static IWearWriteCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IWearWriteCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IWearWriteCallback)) {
                return (IWearWriteCallback) iInterfaceQueryLocalInterface;
            }
        ...
        static class e implements IWearWriteCallback {
            ...
            public void onResult(int i, String str) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IWearWriteCallback.DESCRIPTOR);
