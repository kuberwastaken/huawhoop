...
public class maf {
    ...
    private static final Pattern f5227a = Pattern.compile("[0-9]*[a-z|A-Z]*[一-龥]*");
    ...
    static class maa extends Throwable {
        ...
        public String toString() {
            ...
            String str = name + ": ";
            if (this.f5228a.startsWith(str)) {
                return this.f5228a;
            }
            return str + this.f5228a;
        }
    ...
    public static String a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (f5227a.matcher(String.valueOf(cCharAt)).matches()) {
                if (i % 2 == 0) {
                    cCharAt = '*';
                }
                i++;
