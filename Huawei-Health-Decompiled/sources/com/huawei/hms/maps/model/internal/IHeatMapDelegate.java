...
public interface IHeatMapDelegate extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHeatMapDelegate {
        ...
        static class Proxy implements IHeatMapDelegate {
            ...
            private IBinder f5210a;

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setVisible(boolean z) {
                mab.a(z, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 13);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setRadiusUnit(int i) {
                mab.a(this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 10, Integer.valueOf(i));
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setRadiusMap(Map map) {
                mab.a(map, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 7);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setRadius(String str) {
                mab.a(str, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 6);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setOpacityMap(Map map) {
                mab.a(map, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 5);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setOpacity(String str) {
                mab.a(str, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 4);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setIntensityMap(Map map) {
                mab.a(map, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 9);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setIntensity(String str) {
                mab.a(str, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 8);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void setColor(Map map) {
                mab.a(map, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 3);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void remove() {
                mab.i(this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 2);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public int getRadiusUnit() {
                return mab.b(this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 14);
            }
            ...
            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public String getId() {
                return mab.d(this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 1);
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void changeDataSetFromRes(int i) {
                mab.a(this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 12, Integer.valueOf(i));
            }

            @Override // com.huawei.hms.maps.model.internal.IHeatMapDelegate
            public void changeDataSet(String str) {
                mab.a(str, this.f5210a, "com.huawei.hms.maps.model.internal.IHeatMapDelegate", 11);
            }
