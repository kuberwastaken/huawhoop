...
public class c {
    ...
    private final PLSharedPreferences f4720a;

    public void b(String str, String str2) {
        PLSharedPreferences pLSharedPreferences = this.f4720a;
        if (pLSharedPreferences == null) {
            return;
        }
        synchronized (pLSharedPreferences) {
            this.f4720a.putString(str, str2);
        }
    }
    ...
    public String a(String str, String str2) {
        ...
        synchronized (pLSharedPreferences) {
            string = this.f4720a.getString(str, str2);
        }
        return string;
    }
