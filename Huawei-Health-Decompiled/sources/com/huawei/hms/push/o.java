...
public class o {
    ...
    private JSONObject a(JSONObject jSONObject) throws JSONException {
        ...
        jSONObject2.put(MessageConstant.GROUP_MEDAL_TYPE, this.f5870a);
    ...
    private void g(JSONObject jSONObject) {
        this.f5870a = jSONObject.optString(MessageConstant.GROUP_MEDAL_TYPE);
        HMSLog.d("PushSelfShowLog", "NOTIFY_GROUP:" + this.f5870a);
    ...
    public byte[] n() {
        try {
            return a(a(b(u()), q())).toString().getBytes(m.f5867a);
        } catch (JSONException e) {
    ...
    public byte[] x() {
        return this.s.getBytes(m.f5867a);
    }
