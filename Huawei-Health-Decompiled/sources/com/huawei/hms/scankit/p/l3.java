...
final class l3 {
    ...
    private final b3 f6010a;
    private final byte b;

    private l3(int i) {
        this.f6010a = b3.a((i >> 3) & 3);
        this.b = (byte) (i & 7);
    }
    ...
    static l3 a(int i, int i2) {
        l3 l3VarB = b(i, i2);
        return l3VarB != null ? l3VarB : b(i ^ 21522, i2 ^ 21522);
    }
    ...
    public int hashCode() {
        return (this.f6010a.ordinal() << 3) | this.b;
    }
    ...
    public boolean equals(Object obj) {
        ...
        l3 l3Var = (l3) obj;
        return this.f6010a == l3Var.f6010a && this.b == l3Var.b;
    }
