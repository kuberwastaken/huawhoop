...
public final class SystemManager {
    ...
    private static SystemManager f4459a = new SystemManager();
    ...
    class a implements SystemNotifier {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final List<SystemObserver> f4460a = new ArrayList();
        ...
        public void notifyNoticeObservers(int i) {
            synchronized (SystemManager.b) {
                Iterator<SystemObserver> it = this.f4460a.iterator();
                while (it.hasNext()) {
        ...
        public void registerObserver(SystemObserver systemObserver) {
            if (systemObserver == null || this.f4460a.contains(systemObserver)) {
                return;
            }
            synchronized (SystemManager.b) {
                this.f4460a.add(systemObserver);
            }
        }
        ...
        public void unRegisterObserver(SystemObserver systemObserver) {
            synchronized (SystemManager.b) {
                this.f4460a.remove(systemObserver);
            }
        }
