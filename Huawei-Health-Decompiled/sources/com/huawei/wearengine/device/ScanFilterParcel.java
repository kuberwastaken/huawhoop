...
public class ScanFilterParcel implements Parcelable {
    public static final Parcelable.Creator<ScanFilterParcel> CREATOR = new Parcelable.Creator<ScanFilterParcel>() { // from class: com.huawei.wearengine.device.ScanFilterParcel.5
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: fBR_, reason: merged with bridge method [inline-methods] */
