...
public class PermissionUtil {
    ...
    private static final String f8985a = "PermissionUtil";
    ...
    public static boolean checkPermission(Context context, String str, int i, int i2, String str2) throws NoPermissionCheckerException {
        try {
            ...
            Log.e(f8985a, "checkPermission: " + th.getMessage() + " , you should implementation support library or androidx library");
