...
public class HiPkgSignManager {
    ...
    private static final String f8952a = "HiPkgSignManager";
    ...
    private static PackageInfo a(Context context, String str) {
        try {
            ...
            LogsUtil.e(f8952a, "Exception : " + e.getMessage(), true);
            return null;
        }
    }
    ...
    public static byte[] getInstalledAPPSignature(Context context, String str) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f8952a, "packageName is null or context is null");
            return new byte[0];
        }
        try {
            PackageManager packageManager = context.getPackageManager();
            ...
            LogsUtil.e(f8952a, "PackageManager.NameNotFoundException : " + e.getMessage(), true);
        } catch (Exception e2) {
            LogsUtil.e(f8952a, "Exception : " + e2.getMessage(), true);
        }
        return new byte[0];
    }
    ...
    public static String getUnInstalledAPPPackageName(Context context, String str) {
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f8952a, "archiveFilePath is null or context is null");
            return "";
        }
    ...
    public static byte[] getUnInstalledAPPSignature(Context context, String str) {
        ...
        if (packageInfoA != null) {
            ...
            LogsUtil.e(f8952a, "PackageInfo is null ");
        }
        return new byte[0];
    }
    ...
    private static String b(byte[] bArr) {
        try {
            ...
            LogsUtil.e(f8952a, "NoSuchAlgorithmException" + e.getMessage());
            return "";
        }
    }
    ...
    private static String a(byte[] bArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (i2 < 16) {
                stringBuffer.append("0" + Integer.toHexString(bArr[i] & UnsignedBytes.MAX_VALUE));
            } else {
