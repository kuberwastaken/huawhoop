...
public class HwActivityRecognitionExtendEvent implements Parcelable {
    public static final Parcelable.Creator<HwActivityRecognitionExtendEvent> CREATOR = new Parcelable.Creator<HwActivityRecognitionExtendEvent>() { // from class: com.huawei.systemserver.activityrecognition.HwActivityRecognitionExtendEvent.3
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: cFb_, reason: merged with bridge method [inline-methods] */
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        Log.e("ARMoudle.HwActivityRecognition", "Extend ARServiceVersion : " + HwActivityRecognition.b());
        if (HwActivityRecognition.b() == 1) {
