...
public class OtherParameters implements Parcelable {
    public static final Parcelable.Creator<OtherParameters> CREATOR = new Parcelable.Creator<OtherParameters>() { // from class: com.huawei.systemserver.activityrecognition.OtherParameters.4
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: cFd_, reason: merged with bridge method [inline-methods] */
