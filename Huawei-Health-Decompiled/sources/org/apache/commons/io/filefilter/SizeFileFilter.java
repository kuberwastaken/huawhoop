    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return get(new IOSupplier() { // from class: org.apache.commons.io.filefilter.SizeFileFilter$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return this.f$0.m1654lambda$accept$0$orgapachecommonsiofilefilterSizeFileFilter(path);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$accept$0$org-apache-commons-io-filefilter-SizeFileFilter, reason: not valid java name */
    /* synthetic */ FileVisitResult m1654lambda$accept$0$orgapachecommonsiofilefilterSizeFileFilter(Path path) throws IOException {
